        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              {/* Seller Info */}
              {isAuthenticated && (
                <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200 inline-flex items-center">
                  <svg className="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <span className="text-green-700 font-medium">Ready to sell as {user?.name}</span>
                </div>
              )}
            </div>
          ...
          {!isAuthenticated && (
            <div className="mt-16 text-center">
              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">Want to Sell Your Food?</h3>
                <p className="text-orange-100 mb-6 text-lg">
                  Join our seller community and reach thousands of food lovers
                </p>
                <button
                  onClick={() => navigate('/')}
      ...
      <section className="py-16 bg-gradient-to-r from-orange-50 to-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div
              className="bg-white rounded-2xl p-6 text-center cursor-pointer hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              onClick={() => navigate('/sandwich')}
            >
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🥪</span>
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">Sandwiches</h3>
              <p className="text-sm text-gray-600">Fresh & tasty</p>
            </div>
          </div>
        </div>
      </section>
